class Vorto < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/vorto-editor/vorto/releases/download/v0.14.0/vorto-0.14.0-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/vorto-editor/vorto/releases/download/v0.14.0/vorto-0.14.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "c9ceb953cc9bc3594a8a04f591921e20ca306c56002a6319a455365d008a5872"
    end
    on_intel do
      url "https://github.com/vorto-editor/vorto/releases/download/v0.14.0/vorto-0.14.0-x86_64-unknown-linux-gnu.tar.gz"
